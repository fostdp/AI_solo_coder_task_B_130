...
VALUES (
    ...
    '{"height":4.5,"log_diameter":0.18,"bundle_layers":5,"efficiency_per_unit":0.04}',
    65, 120, 15, 300,
...
VALUES (
    ...
    '{"diameter":0.7,"length":3.5,"porosity":0.35,"stones_per_cage":80}',
    70, 80, 10, 200,
...
VALUES (
    ...
    '{"target_elevation":726.12,"dredging_depth":1.5,"tolerance":0.1}',
    60, 300, 30, 800,
...
VALUES (
    ...
    '{"height":5.5,"log_diameter":0.25,"bundle_layers":7,"efficiency_per_unit":0.05}',
    82, 180, 12, 450,
...
VALUES (
    ...
    '{"diameter":0.9,"length":4.0,"porosity":0.3,"stones_per_cage":120}',
    85, 100, 8, 280,
...
VALUES (
    ...
    '{"target_elevation":726.06,"dredging_depth":2.0,"tolerance":0.05}',
    78, 500, 45, 1500,
...
INSERT INTO modern_repair_comparison (comparison_item, category, ancient_method, modern_method, ancient_efficiency, modern_efficiency, ancient_cost, modern_cost, ancient_env_impact, modern_env_impact, ancient_equipment, modern_equipment, labor_ancient, labor_modern, duration_ancient_days, duration_modern_days, description)
VALUES
('截流技术', 'technology', '杩槎截流：人工捆扎原木竹篾，人力推放入水，压石闭气', '钢围堰截流：钢板桩+混凝土围堰，机械化施工', 60, 95, 100, 150, 30, 70, '斧头、竹锯、木槌、人力', '钢板桩打桩机、起重机、混凝土泵车', 120, 15, 15, 5, '现代钢围堰效率高但成本高环境影响大，古代杩槎生态友好可重复利用'),
('护岸工程', 'technology', '竹笼装石：人工编竹笼，人力抛石，木夯夯实', '雷诺护垫+格宾笼：镀锌钢丝网箱，机械装填，标准化', 65, 90, 80, 130, 20, 50, '竹刀、蔑刀、木夯、人力', '格宾网自动编织机、挖掘机、装载机', 80, 10, 10, 3, '竹笼完全可降解，格宾笼使用寿命长但含镀锌金属'),
('河道清淤', 'technology', '人工淘淤：锄挖筐装，脚踏绞车提升，人力挑运', '环保清淤：绞吸式挖泥船，管道输送，脱水固结', 40, 95, 120, 200, 50, 35, '锄、筐、绞车、扁担', '绞吸式挖泥船、输送管道、脱水设备', 300, 8, 45, 10, '人工清淤慢但精准控制深度，机械清淤快但易扰动底泥'),
('渗漏处理', 'technology', '粘土闭气：稻草拌粘土，分层夯实迎水面', '土工膜防渗：HDPE土工膜，热熔焊接，混凝土压重', 55, 92, 40, 110, 15, 60, '木夯、扁担、木桶', '土工膜焊接机、热熔枪、压实机', 50, 6, 8, 2, '粘土防渗完全生态，土工膜耐久性强但为塑料材料'),
('堤防加固', 'technology', '夯土筑堤：分层夯土，竹筋加筋，草皮护坡', '混凝土护坡+防渗墙：钢筋混凝土，深层搅拌桩', 50, 93, 70, 180, 25, 65, '夯具、扁担、锄头', '混凝土搅拌机、深层搅拌机、振捣器', 200, 20, 30, 7, '夯土堤可呼吸且与环境融合，混凝土堤强度高但改变生态'),
('材料成本', 'cost', '竹木材+卵石：本地取材，运输距离短', '钢材+混凝土：工业生产，长途运输', 100, 250, 100, 300, 10, 80, '本地竹木岷江卵石', '钢厂水泥厂产品', '-', '-', '-', '-', '古代材料成本低但劳动密集，现代材料贵但省人力'),
('人力需求', 'efficiency', '人海战术：岁修征调数千人，工期集中冬春', '机械化：专业施工队数十人，全年可施工', 30, 95, 100, 120, 30, 40, '征调民夫、工匠', '操作工人、工程师', 500, 25, 45, 10, '清代岁修征夫多达五千人，现代专业化施工仅需数十人'),
('工期效率', 'efficiency', '枯水期集中施工，受天气影响大', '全天候机械化，可多工作面平行作业', 45, 90, 100, 90, 35, 50, '人力+简单工具', '大型工程机械', '-', '-', 60, 15, '古代仅冬春枯水期可施工，现代可全年作业'),
('生态影响', 'environment', '竹杩槎+竹笼：可降解可重复，环境友好', '钢铁+混凝土：改变河床形态，阻断鱼类洄游', 15, 70, 100, 80, 10, 65, '完全天然材料', '工业合成材料', '-', '-', '-', '-', '古代工法完全符合生态，现代工程需配套鱼道生态补偿'),
('监测技术', 'technology', '水则碑+卧铁：人工观测，经验判断', '传感器+卫星遥感：实时监测，AI预警', 30, 98, 50, 200, 5, 30, '水则、石碑、竹竿', '水位计、测深仪、卫星、无人机', 2, 1, 1, 1, '现代监测精度达到毫米级，古代依赖工匠经验');
